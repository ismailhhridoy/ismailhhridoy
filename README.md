...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&pause=1000&color=F7971E&center=true&vCenter=true&width=700&lines=Hey+there!+I'm+[YourName]+👋;WordPress+Developer+%26+UX+Designer;300%2B+Websites+%7C+15%2B+Countries+🌍;Building+Digital+Experiences+that+Grow+🚀" alt="Typing SVG" />
</a>
...
available  : ✅ Open for freelance & white-label agency work
fun_fact   : I've built 300+ websites for clients across 15+ countries 🌍
```

> 🌱 *"Great websites communicate clearly, solve problems, create trust, and support business growth."*
...
| 🧩 Service | 📋 Description |
|---|---|
| 🌐 **WordPress Development** | Custom themes, plugins, dynamic CMS solutions |
| 🛒 **WooCommerce** | Fully-featured online stores built for conversion |
| 🎨 **UX Design** | User-focused interfaces that convert visitors to customers |
| ⚡ **Performance Optimization** | Speed audits, Core Web Vitals, caching, CDN setup |
| 🏢 **White-Label Agency Support** | Backend dev support for UK & USA marketing agencies |
| 🔐 **Website Security** | Malware removal, hardening, SSL, firewall setup |
...
| 🌐 **300+** | 🌏 **15+** | ⭐ **5★** | 🤝 **50+** |
|:---:|:---:|:---:|:---:|
| Websites Delivered | Countries Served | Client Satisfaction | Agency Partners |
